const config = {
  ...
  services: [
    ...
    },
    {
      ...
      tagline: "Fast commercial AC repair to keep your business cool.",
      description: "Rooftop units, split systems, package units — we service all commercial air conditioning equipment to keep your employees and customers comfortable.",
    },
    {
      ...
      tagline: "Expert commercial HVAC installation sized for your business.",
      description: "From small retail shops to large warehouses, we design and install commercial heating and cooling systems built for performance and energy efficiency.",
    },
    {
      ...
      tagline: "Preventive maintenance plans for commercial HVAC and refrigeration.",
      description: "Scheduled maintenance keeps your commercial equipment running efficiently, prevents costly breakdowns, and extends the life of your investment.",
    },
  ],
